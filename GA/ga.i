...
typedef int(*GACallbackFnc)(int,int,GApopulation,double*,int***);
extern void GAinit(GADeleteFnc, GACloneFnc ,GAFitnessFnc, GACrossoverFnc, GAMutateFnc, GASelectionFnc, GACallbackFnc);
extern GApopulation GArun(GApopulation,int sz0,int sz1,int maxIter);
extern int GArouletteWheelSelection(GApopulation , double * , double , int, int );
extern int GAtournamentSelection(GApopulation , double * , double , int, int );
extern int GAeliteSelection(GApopulation , double * , double , int , int);
extern int GAhyperbolicSelection(GApopulation , double * , double , int , int );
...
extern GApopulation GAnextGen(int,GApopulation,int,int,short,double*,int***);
...
extern int* getOriginalParents(int,int,int***);
extern int* getImmediateParents(int,int,int***);
...
extern GApopulation evolveNetworks(int,int,int,GAFitnessFnc,GACallbackFnc);
