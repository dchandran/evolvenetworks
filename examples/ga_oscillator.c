...
/****************************************************
	...
	gcc mtrand.c ga.c cvodesim.c ssa.c mass_action_network.c ga_oscillator.c -lm -lcvode
	gcc mtrand.c ga.c cvodesim.c ssa.c protein_network.c ga_oscillator.c -lm -lcvode
	gcc mtrand.c ga.c cvodesim.c ssa.c genetic_network.c ga_oscillator.c -lm -lcvode
