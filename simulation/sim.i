...
extern double* jacobian(int N, double * iv,  ODEFunction function, void * params, double*, double*);
extern double* jacobian2(int m, int n, double * N, PropensityFunction f, double * point, void * params, double*, double*);
