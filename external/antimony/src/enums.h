...
typedef enum {varSpeciesUndef = 0,
               varFormulaUndef,
               varDNA,
               varFormulaOperator,
               varReactionGene,
 ...
 */
typedef enum {constDEFAULT = 0, constVAR, constCONST} const_type;
 ...
 */
typedef enum {formulaINITIAL = 0, formulaASSIGNMENT, formulaRATE, formulaKINETIC, formulaTRIGGER} formula_type;
#endif // ENUMS_H
